...
1. Follow this [tutorial](https://developers.sap.com/tutorials/cp-aibus-dox-booster-app.html) to create instance of Document Informaiton Extraction Service and Subscribe to UI.
